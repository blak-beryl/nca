(function ($) {
  ...
  jQuery(document).on("ready", function () {
    ...
    $(".logo-slider").owlCarousel({
      ...
      autoplayHoverPause: true,
      smartSpeed: 2000,
      responsive: { 0: { items: 2 }, 650: { items: 3 }, 992: { items: 4 } },
    });
    ...
    if ($(".shop-single-slider").length) {
      ...
      $(".slider-nav").slick({
        ...
        focusOnSelect: true,
        responsive: [
          { breakpoint: 500, settings: { slidesToShow: 2, infinite: true } },
    ...
    $("body").append(
      '<div id="toTop" class="back-to-top"><i class="flaticon-drag"></i></div>'
    );
    $(window).on("scroll", function () {
      if ($(this).scrollTop() != 0) {
        $("#toTop").fadeIn();
